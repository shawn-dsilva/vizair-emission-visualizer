...
export default function Map() {
  ...
  return (
    ...
    <div className="map">
      <h1>『 ZA WARUDO 』 </h1>
      <SvgGenerator year={year} setYear={setYear} emissionType={emissionType} setEmissionType={setEmissionType} emissionData={emissionData} setEmissionData={setEmissionData}/>
